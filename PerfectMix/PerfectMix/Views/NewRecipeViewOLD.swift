...
struct NewRecipeViewOld: View {
    ...
    private func saveButtonPressed() {
        ...
        let newRecipe = RecipeModel(id:"0",title: titleTF, description: descriptionTF, portion: 0, time: 1, difficulty: difficulty, category: "")
        Task {
            await recipeViewModel.createRecipe(recipe: newRecipe)
...
struct NewRecipeViewOld_Previews: PreviewProvider {
